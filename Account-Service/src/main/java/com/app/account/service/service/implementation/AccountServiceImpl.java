...
public class AccountServiceImpl implements AccountService {
	 ...
	 *
	 * @param accountDto The accountDto containing the necessary information to
	 *                   create an account.
	 * @return The response indicating the result of the account creation.
	 * @throws ResourceNotFound If the user associated with the accountDto does not
	 *                          exist.
	 * @throws ResourceConflict If an account with the same userId and accountType
	 *                          already exists.
	 */
	@Override
	 ...
	 * @throws InSufficientFunds      If the account balance is below the minimum
	 *                                required balance.
	 ...
	 * @param accountDto    The account DTO containing the updated account
	 *                      information.
	 ...
	 * @throws ResourceNotFound if the account with the given account number is not
	 *                          found.
	 */
	@Override
	 ...
	 * @throws ResourceNotFound        If the account with the specified account
	 *                                 number is not found.
